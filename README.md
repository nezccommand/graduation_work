[![Image from Gyazo](https://i.gyazo.com/a24fe7acaa95a5f2c396dcfc22da1599.png)](https://gyazo.com/a24fe7acaa95a5f2c396dcfc22da1599)
## ■サービス概要
...
* **Googleログイン機能を活用し、ユーザー登録への負担を削減する**  
...
* **掲示板系の機能を主要の機能としてではなく、「サービスの一部」として設計**  
...
* クイズの難易度分け(高難易度を追加)
* バッジ機能の追加(各難易度・各ジャンル全問正解でバッジ付与)
* 管理画面(クイズの問題などを編集できるようにする機能など)
* Google認証(より気軽にログイン機能を使えるように）
